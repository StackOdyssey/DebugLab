...
export function Hero({ onOpenTerminal, onOpenCertModal }) {
  ...
  return (
    <section className="relative pt-10 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
      {/* Background ambient accents - unified soft warm glow */}
      <div className="absolute top-10 right-10 w-96 h-96 bg-amber-300/10 dark:bg-amber-400/5 rounded-full blur-3xl -z-10 pointer-events-none" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="font-mono text-sm font-black uppercase tracking-widest text-black dark:text-gray-200 bg-gray-100 dark:bg-gray-800 px-2 py-0.5 border border-black inline-block">
                HELLO WORLD, I'M
              </span>
            </div>
          ...
          <div className="bg-brutal-yellow text-black border-3 border-black p-4 shadow-brutal font-mono flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-black text-brutal-yellow border-2 border-black shrink-0 shadow-brutal-sm">
                <Target className="w-5 h-5" />
              </div>
              <div>
                <div className="text-[10px] font-black uppercase bg-black text-white px-1.5 py-0.2 inline-block mb-0.5">
                  CORE SPECIALIZATION
                </div>
            ...
            >
              ...
              <ArrowRight className="w-3.5 h-3.5 text-brutal-yellow" />
            </a>
          </div>
          ...
          <div
            ...
            className="cursor-pointer group inline-flex items-center gap-2 text-xs sm:text-sm font-mono font-black bg-black text-white px-4 py-2 border-2 border-black shadow-brutal-sm hover:bg-gray-900 transition-all"
            title="Click to cycle dynamic quote"
          >
            <Sparkles className="w-4 h-4 animate-spin-slow text-brutal-yellow" />
            <span>"{PORTFOLIO.taglines[taglineIdx]}"</span>
            <span className="text-[11px] text-gray-400 font-bold ml-1.5 opacity-90 group-hover:opacity-100 transition-opacity">
              (Click to shuffle)
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2">
            ...
            <Button
              ...
              variant="white"
              size="lg"
              className="border-3 border-black shadow-brutal hover:bg-gray-100"
            >
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="relative bg-white dark:bg-brutal-darkCard border-4 border-black shadow-brutal-xl p-5 overflow-hidden">
            ...
            <div className="flex items-center justify-between border-b-3 border-black pb-3 mb-4 font-mono font-black text-xs uppercase bg-gray-100 dark:bg-gray-800 -mx-5 -mt-5 px-5 pt-3">
              <span className="flex items-center gap-1.5 text-black dark:text-white">
                <Code2 className="w-4 h-4" /> ID: STACKODYSSEY
              </span>
              <span className="bg-black text-white dark:bg-white dark:text-black px-2 py-0.5 text-[10px]">VERIFIED</span>
            </div>

            {/* Visual Icon Avatar with retro stickers */}
            <div className="relative aspect-square bg-gray-50 dark:bg-gray-900 border-3 border-black p-4 flex flex-col items-center justify-center text-center overflow-hidden group">
              ...
              <div className="absolute top-2 right-2 -rotate-12">
                <span className="bg-black text-white text-[10px] font-mono font-black px-1.5 py-0.5 border border-black shadow-brutal-sm">
                  Cisco
                </span>
              </div>
              <div className="absolute top-2 left-2 rotate-12">
                <span className="bg-brutal-yellow text-black text-[10px] font-mono font-black px-1.5 py-0.5 border border-black shadow-brutal-sm">
                  Google Ads
                </span>
              </div>
              <div className="absolute bottom-2 left-2 rotate-6">
                <span className="bg-white text-black text-[10px] font-mono font-black px-1.5 py-0.5 border border-black shadow-brutal-sm">
                  ALX Africa
                </span>
              </div>
            </div>
