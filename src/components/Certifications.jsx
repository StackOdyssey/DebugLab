      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 pb-4 border-b-4 border-black gap-4">
        <div>
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase font-sans tracking-tight text-black dark:text-white">
            CERTIFICATIONS <span className="text-brutal-yellow">&</span> ACADEMICS
          </h2>
        </div>
          ...
          return (
            <Card
              ...
              header={
                <div className="flex items-center justify-between w-full">
                  ...
                  <span className="bg-black text-white dark:bg-white dark:text-black px-1.5 py-0.5 text-[10px] font-black border border-black">
                    {cert.date}
                  </span>
                </div>
              }
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-[10px] font-mono font-black text-gray-500 dark:text-gray-400 flex items-center gap-1">
              ...
              {/* Title */}
              <h3 className="text-xl font-black font-sans tracking-tight text-black dark:text-white mb-2 leading-snug">
                {cert.title}
              </h3>
              ...
              <Button
                variant="white"
                size="sm"
                className="w-full justify-between mt-auto group-hover:bg-brutal-yellow group-hover:text-black transition-colors"
        ...
        {selectedCert && (
          <div className="space-y-5">
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800 border-3 border-black shadow-brutal-sm space-y-2">
              <div className="flex items-center justify-between text-xs font-mono font-bold text-gray-600 dark:text-gray-300 border-b border-gray-300 dark:border-gray-700 pb-2">
                <span>CREDENTIAL ID: <strong className="text-black dark:text-white font-black">{selectedCert.codeStamp}</strong></span>
                <span className="bg-emerald-100 text-emerald-800 border border-emerald-500 px-2 py-0.5 font-black text-[10px]">
                  AUTHENTICATED RECORD
                </span>
              </div>
              <p className="text-sm font-sans font-medium text-gray-900 dark:text-gray-100 pt-1">
            ...
            <div>
              <h4 className="text-xs font-mono font-black uppercase text-black dark:text-white mb-2 tracking-wider">
              ...
              <div className="grid grid-cols-2 gap-2">
                {selectedCert.skills.map((skill, idx) => (
                  <div 
                    key={idx}
                    className="p-2 bg-gray-50 dark:bg-gray-800 border-2 border-black font-mono text-xs font-bold text-black dark:text-white flex items-center gap-2"
                  >
