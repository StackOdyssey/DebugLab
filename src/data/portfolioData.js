  ...
  projects: [
    {
      ...
      repoName: "safe-hands-logistics-crm",
      badgeText: "ENTERPRISE CASE STUDY",
      description: "A production-grade Next.js enterprise web portal and logistics management platform featuring Prisma ORM database models, multi-lingual internationalization, dynamic freight quotation calculators, and technical SEO architecture.",
    ...
    },
    {
      ...
      description: "A modern, modular React.js web application built with clean component hierarchy, custom hooks, dynamic state management, and responsive layouts.",
    ...
    },
    {
      ...
      description: "Full-featured Django backend application featuring relational data models, RESTful endpoints, user authentication, and persistent database CRUD operations.",
    ...
    },
    {
      ...
      description: "High-performance JavaScript productivity application with dynamic DOM rendering, local persistence, task priority categorisation, and smooth interactions.",
    ...
    },
    {
      ...
      description: "Timed algorithmic quiz application evaluating front-end and programming knowledge with instant score calculation, feedback, and animated questions.",
