  ...
  projects: [
    {
      ...
      description: "A production-grade Next.js enterprise web portal and logistics management platform featuring Prisma ORM database models, multi-lingual internationalization, dynamic freight quotation calculators, and technical SEO architecture built for a real commercial client.",
      tech: ["Next.js", "TypeScript", "Prisma ORM", "PostgreSQL", "Tailwind CSS", "i18n Localization", "SEO Systems"],
      highlights: [
        "Real-world enterprise system deployed for commercial logistics operations",
